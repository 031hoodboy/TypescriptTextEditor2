...
function useMonolithicRenderer(renderer) {
  ...
  renderer._renderStyleToCache = function (className, style) {
    ...
    var ruleSet = (0, _objectReduce2.default)(style, function (ruleset, value, property) {
    ...
    if (Object.keys(ruleSet).length > 0) {
      ...
      var selector = (0, _felaUtils.generateCSSSelector)(className, pseudo, renderer.specificityPrefix);
